      ...
      <main className="h-[100vh] w-screen bg-black/90 grid grid-cols-6 ">
        <div className="col-span-4 ">
          <div className="w-full h-full  flex flex-col justify-between py-5 pl-12">
            ...
            <motion.div
              ...
              className="tracking-wide leading-relaxed font-bold font-monospace text-lg  text-white/70"
            >
        ...
        <div className="col-span-2 ">
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 3, delay: 2 }}
            className="flex flex-row justify-start items-center content-center h-full"
          >
